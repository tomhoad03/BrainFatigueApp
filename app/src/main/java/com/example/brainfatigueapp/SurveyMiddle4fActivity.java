...
public class SurveyMiddle4fActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageButton surveyBackBtn = findViewById(R.id.activity_survey_middle4f_back_button);
        surveyBackBtn.setOnClickListener(v -> {
            Intent intent = new Intent(SurveyMiddle4fActivity.this, SurveyMiddle3Activity.class);
